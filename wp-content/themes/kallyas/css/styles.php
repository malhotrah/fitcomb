...
<?php
	...
	elseif ( isset ( $data['def_bottom_style'] ) && $data['def_bottom_style'] == 'mask1' && $data['zn_main_style'] == 'dark' )  {
		echo '#page_header.zn_def_header_style .zn_header_bottom_style , #slideshow.zn_def_header_style .zn_header_bottom_style {';
			echo 'position:absolute; bottom:0; left:0; width:100%; height:27px; z-index:99; background:url(../images/bottom_mask_dark.png) no-repeat center top;';
		echo '}';
	}
	...
	elseif ( isset ( $data['def_bottom_style'] ) && $data['def_bottom_style'] == 'mask2' && $data['zn_main_style'] == 'dark' ) {
		echo '#page_header.zn_def_header_style .zn_header_bottom_style , #slideshow.zn_def_header_style .zn_header_bottom_style {';
			echo 'position:absolute; bottom:0; left:0; width:100%;  z-index:99; ';
			echo 'height:33px; background:url(../images/bottom_mask2_dark.png) no-repeat center top;';
		echo '}';
	}
?>
...
.login-panel .login_facebook {background-color:<?php echo $data['zn_main_color'];?>;}
...
header#header , .oldie #page_wrapper header#header{
	...
	<?php if( !empty($data['header_style']) && $data['header_style'] == 'image_color' && !empty($data['header_style_image']['image'])){ echo 'background-image:url("'.$data['header_style_image']['image'].'");'."\n"; } elseif(!empty($data['header_style']) && $data['header_style'] == 'image_color') { echo 'background-image:none;'; } ?>
