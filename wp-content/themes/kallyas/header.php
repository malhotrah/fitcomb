    ...
    <div id="page_wrapper">
        <header id="header" class="<?php echo $data['zn_header_layout'] .' '. $header_css; ?>">
            <div class="container">
				...
				<?php } ?>
				<!-- kapap Logo -->
<a href="http://www.kapapacademy.com/" target="_blank" style="
    float: right;
"><img src="/wp-content/uploads/2014/11/kapap_logo.jpg" alt="Fitcomb" title="Fitcomb-The Protection Professionals"></a>
				<!-- kapap logo end -->
				<!-- main menu -->
